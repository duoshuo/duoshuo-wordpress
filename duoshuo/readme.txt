...
1. 手机界面深度优化适配：自动识别访问者使用的移动设备，自动适应各种宽度的手机浏览器
1. 主题样式随意切换：CSS代码全面开源，你可以深度定制属于自己的主题样式
...
2. 针对手机界面深度优化，响应式的设计自动适配各种移动终端
3. 评论列表单级回复样式
4. 你的评论被回复之后，实时提醒
5. 多款主题供您选择，深色背景的网站毫无违和感。CSS样式代码全面开源，供您深度定制属于自己的评论框
6. 集成在WordPress后台的多说评论管理界面，智能过滤垃圾评论

== Changelog ==
= 1.2 (2015-11-23) =
* [修正]修复多说在https下无法使用的问题
* [改进]更彻底的清空站点配置,重置所有关联数据
